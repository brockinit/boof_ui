    ...
    <div className="about-us-body-container">
      <div className="about-us-content-container">
        ...
        <p>
          ...
          football, it would be Persian cats.
        </p>
        <h2>Sal</h2>
        <p>
        ...
        <h2>Andrea</h2>
        <p>
          As the jack of all trades and master of none, Andrea is a developer
          who also has dabbled in digital advertising, product development, and
          project management. As the resident grandmother of the group, she has
          played fantasy football for a staggering 16 consecutive years,
          bringing wisdom and bullshit luck to the field for the majority of
          that time. When not crushing the boys in fantasy football, she is a
          fan of adventure and has traveled solo to over 10 countries. Andrea
          enjoys a good ear of corn and is still going to send it.
        </p>
      </div>
    </div>
  );
